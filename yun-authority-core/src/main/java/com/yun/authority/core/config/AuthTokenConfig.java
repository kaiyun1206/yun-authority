 ...
 * <p>
 * Token 配置类
 * 可以通过yml、properties、java代码等形式配置本类参数
 * </p>
 *
 * @author sunkaiyun
 * @version 1.0
 * @date 2021-08-08 22:42
 */
public class AuthTokenConfig implements Serializable {
    private static final long serialVersionUID = 7000921268144522994L;

    /**
     * token名称 (同时也是cookie名称)
     */
    private String tokenName = "yuntoken";
    ...
    /**
     * token前缀, 格式样例(yuntoken: Bearer xxxx-xxxx-xxxx-xxxx)
     */
    ...
    /**
     * jwt秘钥 (只有集成 yun-token-temp-jwt 模块时此参数才会生效)
     */
     ...
     * @return 对象自身
     */
    public AuthTokenConfig setTokenName(String tokenName) {
     ...
     * @return 对象自身
     */
    public AuthTokenConfig setTimeout(long timeout) {
     ...
     * @return 对象自身
     */
    public AuthTokenConfig setActivityTimeout(long activityTimeout) {
     ...
     * @return 对象自身
     */
    public AuthTokenConfig setIsConcurrent(Boolean isConcurrent) {
     ...
     * @return 对象自身
     */
    public AuthTokenConfig setIsShare(Boolean isShare) {
     ...
     * @return 对象自身
     */
    public AuthTokenConfig setIsReadBody(Boolean isReadBody) {
     ...
     * @return 对象自身
     */
    public AuthTokenConfig setIsReadHead(Boolean isReadHead) {
     ...
     * @return 对象自身
     */
    public AuthTokenConfig setIsReadCookie(Boolean isReadCookie) {
     ...
     * @return 对象自身
     */
    public AuthTokenConfig setTokenStyle(String tokenStyle) {
     ...
     * @return 对象自身
     */
    public AuthTokenConfig setDataRefreshPeriod(int dataRefreshPeriod) {
     ...
     * @return 对象自身
     */
    public AuthTokenConfig setTokenSessionCheckLogin(Boolean tokenSessionCheckLogin) {
     ...
     * @return 对象自身
     */
    public AuthTokenConfig setAutoRenew(Boolean autoRenew) {
     ...
     * @return 对象自身
     */
    public AuthTokenConfig setCookieDomain(String cookieDomain) {
        this.cookieDomain = cookieDomain;
        return this;
    }

    /**
     * @return token前缀, 格式样例(token: Bearer xxxx-xxxx-xxxx-xxxx)
     */
    ...
    /**
     * @param tokenPrefix token前缀, 格式样例(token: Bearer xxxx-xxxx-xxxx-xxxx)
     * @return 对象自身
     */
    public AuthTokenConfig setTokenPrefix(String tokenPrefix) {
     ...
     * @return 对象自身
     */
    public AuthTokenConfig setIsLog(Boolean isLog) {
        this.isLog = isLog;
        return this;
    }
    ...
    /**
     * @param jwtSecretKey jwt秘钥 (只有集成 yun-auth-temp-jwt 模块时此参数才会生效)
     * @return 对象自身
     */
    public AuthTokenConfig setJwtSecretKey(String jwtSecretKey) {
     ...
     * @return 对象自身
     */
    public AuthTokenConfig setIdTokenTimeout(long idTokenTimeout) {
     ...
     */
    public void setSSO(AuthSSOConfig sso) {
        this.sso = sso;
    }

    @Override
    public String toString() {
        return "AuthTokenConfig [tokenName=" + tokenName + ", timeout=" + timeout + ", activityTimeout=" + activityTimeout
                ...
                + ", isLog=" + isLog + ", jwtSecretKey=" + jwtSecretKey + ", idTokenTimeout="
