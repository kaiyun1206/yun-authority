...
public class OAuth2Util {
     ...
     * 模板代码对象 
     */
    public static OAuth2Template oAuth2Template = new OAuth2Template();
     ...
     * @return ClientModel
     */
    public static ClientModel checkClientModel(String clientId) {
    ...
    public static AccessTokenModel checkAccessToken(String accessToken) {
        return oAuth2Template.checkAccessToken(accessToken);
    }
    ...
    public static ClientTokenModel checkClientToken(String clientToken) {
        return oAuth2Template.checkClientToken(clientToken);
    }
    ...
    public static Object getLoginIdByAccessToken(String accessToken) {
        return oAuth2Template.getLoginIdByAccessToken(accessToken);
    }
    ...
    public static void checkScope(String accessToken, String... scopes) {
        oAuth2Template.checkScope(accessToken, scopes);
    }
     ...
     */
    public static RequestAuthModel generateRequestAuth(AuthRequest req, Object loginId) {
        return oAuth2Template.generateRequestAuth(req, loginId);
    }
    ...
    public static CodeModel generateCode(RequestAuthModel ra) {
        return oAuth2Template.generateCode(ra);
    }
    ...
    public static AccessTokenModel generateAccessToken(String code) {
        return oAuth2Template.generateAccessToken(code);
    }
    ...
    public static AccessTokenModel refreshAccessToken(String refreshToken) {
        return oAuth2Template.refreshAccessToken(refreshToken);
    }
    ...
    public static AccessTokenModel generateAccessToken(RequestAuthModel ra, boolean isCreateRt) {
        return oAuth2Template.generateAccessToken(ra, isCreateRt);
    }
    ...
    public static ClientTokenModel generateClientToken(String clientId, String scope) {
        return oAuth2Template.generateClientToken(clientId, scope);
    }
    ...
    public static String buildRedirectUri(String redirectUri, String code, String state) {
        return oAuth2Template.buildRedirectUri(redirectUri, code, state);
    }
    ...
    public static String buildImplicitRedirectUri(String redirectUri, String token, String state) {
        return oAuth2Template.buildImplicitRedirectUri(redirectUri, token, state);
    }
    ...
    public static boolean isGrant(Object loginId, String clientId, String scope) {
        return oAuth2Template.isGrant(loginId, clientId, scope);
    }
    ...
    public static void checkRightUrl(String clientId, String url) {
        oAuth2Template.checkRightUrl(clientId, url);
    }
     ...
     */
    public static ClientModel checkClientSecret(String clientId, String clientSecret) {
        return oAuth2Template.checkClientSecret(clientId, clientSecret);
    }
    ...
    public static CodeModel checkGainTokenParam(String code, String clientId, String clientSecret, String redirectUri) {
        return oAuth2Template.checkGainTokenParam(code, clientId, clientSecret, redirectUri);
    }
    ...
    public static RefreshTokenModel checkRefreshTokenParam(String clientId, String clientSecret, String refreshToken) {
        return oAuth2Template.checkRefreshTokenParam(clientId, clientSecret, refreshToken);
    }
    ...
    public static AccessTokenModel checkAccessTokenParam(String clientId, String clientSecret, String accessToken) {
        return oAuth2Template.checkAccessTokenParam(clientId, clientSecret, accessToken);
    }
    ...
    public static CodeModel getCode(String code) {
        return oAuth2Template.getCode(code);
    }
    ...
    public static AccessTokenModel getAccessToken(String accessToken) {
        return oAuth2Template.getAccessToken(accessToken);
    }
    ...
    public static RefreshTokenModel getRefreshToken(String refreshToken) {
        return oAuth2Template.getRefreshToken(refreshToken);
    }
    ...
    public static ClientTokenModel getClientToken(String clientToken) {
        return oAuth2Template.getClientToken(clientToken);
    }
    ...
    public static String getGrantScope(String clientId, Object loginId) {
        return oAuth2Template.getGrantScope(clientId, loginId);
    }
