package com.yun.authority.oauth2.config;
 ...
 * @author sunkaiyun
 * @version 1.0
 * @date 2021-08-11 19:59
 */
public class OAuth2Config implements Serializable {
    private static final long serialVersionUID = 4857884728250346684L;
     ...
     * @return 对象自身
     */
    public OAuth2Config setNotLoginView(Supplier<Object> notLoginView) {
     ...
     * @return 对象自身
     */
    public OAuth2Config setConfirmView(BiFunction<String, String, Object> confirmView) {
     ...
     * @return 对象自身
     */
    public OAuth2Config setDoLoginHandle(BiFunction<String, String, Object> doLoginHandle) {
    ...
    public String toString() {
        return "OAuth2Config [isCode=" + isCode + ", isImplicit=" + isImplicit + ", isPassword=" + isPassword
